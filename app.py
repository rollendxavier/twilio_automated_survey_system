...
def record():
    ...
    if 'RecordingUrl' in request.values:
        response.say("Thank you for giving your response.")
        response.say("Press 1 to go back to the main menu, 2 to go to question 2, or 3 if there is no answer received and you want to try again.")
